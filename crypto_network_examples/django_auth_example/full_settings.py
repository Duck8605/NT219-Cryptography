...
This is a complete settings.py file for the Django authentication example
with password and OTP functionality.
"""
...
# Database
# SQLite for development, consider PostgreSQL or MySQL for production
DATABASES = {
    'default': {
...
# OTP settings
OTP_TOTP_ISSUER = 'UIT Security'  # Change to your organization name
